  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 pb-20">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onBack}
        className="fixed bottom-6 left-6 z-10 flex items-center gap-1 sm:gap-2 px-4 py-3 bg-gray-800/90 hover:bg-gray-700 
                   rounded-full shadow-lg text-white transition-colors group text-sm sm:text-base"
      >
